    ...
    <div class="col-xl-8 col-lg-7">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <hr>
          Styling for the area chart can be found in the <code>/{{asset('js/demo/chart-area-demo.js')}}</code> file.
        </div>
      </div>
    ...
    <div class="col-xl-4 col-lg-5">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <hr>
          Styling for the donut chart can be found in the <code>/{{asset('js/demo/chart-pie-demo.js')}}</code> file.
        </div>
      </div>
    </div>
  </div>
